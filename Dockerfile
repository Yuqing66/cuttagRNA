FROM ubuntu:16.04
LABEL author="yuqing.wang@umassmed.edu"  description="Docker image containing all requirements for the dolphinnext/cuttagRNA_pipeline"
...
ENV PATH /opt/conda/envs/dolphinnext-cuttagRNA-1.0/bin:/usr/local/bin/dolphin-tools/:$PATH
